...
CREATE TYPE "public"."admin_user_role" AS ENUM('admin', 'marketing', 'user');--> statement-breakpoint
...
ALTER TABLE "user" ALTER COLUMN "role" SET DEFAULT 'user'::"public"."admin_user_role";--> statement-breakpoint
ALTER TABLE "user" ALTER COLUMN "role" SET DATA TYPE "public"."admin_user_role" USING "role"::"public"."admin_user_role";--> statement-breakpoint
